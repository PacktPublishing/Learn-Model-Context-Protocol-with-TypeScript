...
You can run the inspector with this command:
...
Try testing a tool that doesn't exist like "add3" with this command:

```sh
npx @modelcontextprotocol/inspector --cli node ./build/app.js --method tools/call --tool-name add3 --tool-arg a=1 --tool-arg b=2
```
...
```sh
npx @modelcontextprotocol/inspector --cli node ./build/app.js --method tools/call --tool-name add --tool-arg a=1 --tool-arg d=2
```
